...
export const guestValidationSchema = object().shape({
  firstName: string().matches(/^[a-zA-Z]/, "Only numbers not allowed").ensure().required("First name is required"),
  lastName: string().matches(/^[a-zA-Z]/, "Only numbers not allowed").ensure().required("Last name is required"),
